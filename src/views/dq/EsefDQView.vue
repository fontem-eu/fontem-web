...
onMounted(() => { document.title = 'ESEF Data Quality — GMR' })
const data = ref(null)
...
<template>
  <div class="dq"><header class="dq-hdr"><div><router-link to="/admin/data-quality" class="dq-back">&larr; Data Quality</router-link><h1>EU ESEF Financials</h1><p class="dq-sub">European financial statements — XBRL coverage and country distribution</p></div><ThemeToggle /></header>
    ...
    <template v-else-if="data">
      ...
      <section class="dq-section"><h2>Filings by Country</h2><HorizontalBarChart :data="countryBars" /></section>
