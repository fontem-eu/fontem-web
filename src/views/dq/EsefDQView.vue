...
<template>
  <div class="dq"><header class="dq-hdr"><div><router-link to="/data-quality" class="dq-back">&larr; Data Quality</router-link><h1>EU ESEF Financials</h1><p class="dq-sub">European financial statements — XBRL coverage and country distribution</p></div><ThemeToggle /></header>
