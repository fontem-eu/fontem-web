...
<template>
  <div class="dq"><header class="dq-hdr"><div><router-link to="/admin/data-quality" class="dq-back">&larr; Data Quality</router-link><h1>FIRDS Instruments</h1><p class="dq-sub">ESMA Financial Instruments Reference Data — ISIN coverage, instrument types, trading venues</p></div><ThemeToggle /></header>
