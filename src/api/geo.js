...
/*
 * The NUTS region list and the name search live in `./nuts.js` now — they
 * are served by the public /api/nuts surface, not by /api/geo. Boundaries
 * and aggregation stay here: they are map data, not names.
 */
