...
const TIMESPANS = [
  ...
  { key: 'all', label: 'zoomable_line_chart.all', months: null },
]

const GRANULARITIES = [
  { key: 'day', label: 'zoomable_line_chart.day' },
  { key: 'week', label: 'zoomable_line_chart.week' },
  { key: 'month', label: 'zoomable_line_chart.month' },
  { key: 'year', label: 'zoomable_line_chart.year' },
]
